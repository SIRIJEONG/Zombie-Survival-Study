...
public class Zombie : LivingEntity
{
    ...
    private void Awake()
    {
        ...
        //랜더러 컴포넌트는 자식 게임 오브젝트에 있으므로 GetComponentInChildren() 메서드 사용 
    ...
    private IEnumerator UpdatePath()
    {
        ...
        while (!dead)
        {
            ...
            else
            {
                ...
                {
                    //모든 콜라이더로 부터 LivingEntit 컴포넌트 가져오기 
    ...
    public override void Die()
    {
        ...
        Collider[] zombieCollider = GetComponents<Collider>();
        for (int i = 0; i < zombieCollider.Length; i++)
        {
            zombieCollider[i].enabled = false;
        }
